...
bool render() {
  ...
  for (auto &e : meshes) {
	...
	glUniformMatrix4fv(eff.get_uniform_location("M"), 1, GL_FALSE, value_ptr(vec3(1.0f, 0.0f, 0.0f)));
    // Set N matrix uniform - remember - 3x3 matrix
	glUniformMatrix4fv(eff.get_uniform_location("N"), 1, GL_FALSE, value_ptr(vec3(1.0f, 0.0f, 0.0f)));
