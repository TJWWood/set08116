...
bool render() {
  ...
  for (auto &e : meshes) {
	...
	glUniformMatrix3fv(eff.get_uniform_location("M"), 1, GL_FALSE, value_ptr(vec3(1.0f, 0.0f, 0.0f)));
    // Set N matrix uniform - remember - 3x3 matrix
	glUniformMatrix3fv(eff.get_uniform_location("N"), 1, GL_FALSE, value_ptr(vec3(1.0f, 0.0f, 0.0f)));
	...
	glUniform4f(eff.get_uniform_location("shininess"), 50.0f, 50.0f, 50.0f, 50.0f);
	...
	glUniform3fv(eff.get_uniform_location("eye_pos"), 1, value_ptr(cam.get_view()));
    // *********************************
    // Render mesh
    renderer::render(m);
  }
